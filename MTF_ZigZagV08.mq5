...
//n1=0;
  bool bFoundS = false;
  bool bFoundL = false;
  int local_visible_bars=0;
  int local_first_visible_bar=0;
...
// if chart bars change then recalc all
  local_visible_bars = ChartGetInteger(0, CHART_VISIBLE_BARS, 0);
  local_first_visible_bar = ChartGetInteger(0, CHART_FIRST_VISIBLE_BAR, 0);
  if(  g_visible_bars != local_visible_bars || g_first_visible_bar != local_first_visible_bar ) {
    limit = rates_total - 1;

    top_S_new = 0; top_S_prev = 0;
    bottom_S_new = 0; bottom_S_prev = 0;

    top_L_new = 0; top_L_prev = 0;
    bottom_L_new = 0; bottom_L_prev = 0;

    ishift_S_latest = 0;
    ishift_S_latest2 = 0;

    ishift_S_Top_latest = 0;
    ishift_S_Top_prev = 0;
    ishift_S_Bot_latest = 0;
    ishift_S_Bot_prev = 0;
    ...
    ishift_L_Top_latest = 0;
    ishift_L_Top_prev = 0;
    ishift_L_Bot_latest = 0;
    ishift_L_Bot_prev = 0;
